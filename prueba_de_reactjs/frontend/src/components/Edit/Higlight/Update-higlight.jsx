                        ...
                        <div className="card-body">
                            <form className="d-flex flex-column" onSubmit={higlightSubmit} noValidate>
                                ...
                                <div className="form-group">
                                    ...
                                    <button className="btn btn-light" onClick={showNewsSelector} style={{fontSize: "1.2rem"}}>
                                        Choose Article
                                    </button>
                                ...
                                <button type="submit" className="btn-lg btn-info body-form-next" >Update Higlight</button>
                            </form>
                        </div>
                    </div>
                </div>
