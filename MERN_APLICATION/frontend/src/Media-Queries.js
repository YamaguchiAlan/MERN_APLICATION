...
export const Queries= () => {
    if(mediaQuery.matches){
        ...
        if(document.getElementById("header-selector-signin")){
            document.getElementById("header-selector-signin").style.display="initial"
        }
    } else{
        const searchBar = document.getElementById("search-bar")
        const dropdown = document.getElementById("dropdown-menu")
        ...
        if(document.getElementById("header-selector-signin")){
            document.getElementById("header-selector-signin").style.display="none"
        }
    }
}
